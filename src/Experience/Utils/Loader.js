...
// import { BasisTextureLoader } from 'three'
...
export default class Resources extends EventEmitter
{
    ...
    setLoaders()
    {
        ...
        this.loaders.push({
            extensions: ['glb', 'gltf'],
            action: (_resource) => {
                // console.log('Loading resource:', _resource.source);
                gltfLoader.load(
                    _resource.source,
                    (data) => {
                        // console.log('Successfully loaded:', _resource.source);
                        this.fileLoadEnd(_resource, data);
                        // this.singleAssetLoaded(_resource, file);
                    },
                    undefined,
                    (error) => {
                        console.error('An error occurred while loading the GLTF model:', error, _resource.source);
                    }
                );
            }
        });
