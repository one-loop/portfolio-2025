      ...
      <div className="gradient projects">
        ...
        <div className="showcase-grid">
          ...
          <div className="grid-item item2" style={item2Bg.style}>
            ...
            <div className="grid-item-header-overlay">
              <h1>Fieldnotes.</h1>
              <p>An open-source read it later app built with the MERN stack for Fall '25 Agile Software Development @ NYU.</p>
            </div>
            <div className="grid-item-overlay">
